  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Logins">
        ...
        <Stack.Screen name="MyPage_Location" component={MyPgae_Location} 
          options={{   headerTitle: '동네 설정',   headerTitleStyle: {fontSize: 25}, }} />
        <Stack.Screen name="Like_List" component={Mypage_Like_List} 
          options={{   headerTitle: '관심 목록',   headerTitleStyle: {fontSize: 25}, }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
